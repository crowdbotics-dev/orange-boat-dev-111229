"""
Django settings for orange_boat_dev_111229 project.
...
ROOT_URLCONF = 'orange_boat_dev_111229.urls'
...
WSGI_APPLICATION = 'orange_boat_dev_111229.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "orange_boat_dev_111229 API",
    "DESCRIPTION": "API documentation for orange_boat_dev_111229 App",
    "VERSION": "v1",
}
